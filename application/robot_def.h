...
// 云台参数
#define YAW_CHASSIS_ALIGN_ECD 2182   // Hero: no imu yet
#define PITCH_HORIZON_ECD 7609      // 云台处于水平位置时编码器值,若对云台有机械改动需要修改
#define PITCH_MAX_ANGLE 20.0f       // 云台竖直方向最大角度,陀螺仪deg,向上为正,根据机械限位实测后修改
#define PITCH_MIN_ANGLE -15.0f      // 云台竖直方向最小角度,陀螺仪deg,向下为负,根据机械限位实测后修改
